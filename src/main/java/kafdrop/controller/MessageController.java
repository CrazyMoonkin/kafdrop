...
public final class MessageController {
    ...
    public String viewAllMessages(@PathVariable("name") String topicName,
        ...
        types.add("asdasd");
        model.addAttribute("messageTypes", types);
        messages.sort(Comparator.comparing(MessageVO::getTimestamp));
        model.addAttribute("messages", types);
    ...
    public String viewMessageForm(@PathVariable("name") String topicName,
        ...
        model.addAttribute("keyFormats", KeyFormat.values());
        model.addAttribute("descFiles", protobufProperties.getDescFilesList());
        model.addAttribute("messageTypes", protobufProperties.getMessageTypes());
...
//            if (deserializers.getValueDeserializer() instanceof ProtobufMessageDeserializer) {
//            model.addAttribute("messageTypes",
//                        ((ProtobufMessageDeserializer) deserializers.getKeyDeserializer()).getMessageTypes());
//            }
